...
def barrank_tab(webs, usrweb):
    ...
    def make_plot(src):
        ...
        p = figure(x_range=params, plot_height=450, toolbar_location=None,
        ...
        p.vbar(x=dodge('params',-0.15,range=p.x_range),
                        top = 'Standard', width=0.25, source=source, color = "#c9d9d3", legend=value("Standard"))
        p.vbar(x=dodge('params',0.15,range=p.x_range),
                        top = 'input', width=0.25, source=source, color = "#718dbf", legend=value("input cite"))
